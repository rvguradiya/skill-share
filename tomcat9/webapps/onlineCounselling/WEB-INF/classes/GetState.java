...
//List<StateDTO> result; no need directly StateResponse.result= krege
...
applicationResponse.result=servletContext.getAttribute("states");
...
{
System.out.println("Error in GetState Servlet : "+exception); // remove after testing
}
