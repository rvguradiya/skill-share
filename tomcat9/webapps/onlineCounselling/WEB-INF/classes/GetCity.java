...
//List<CityDTO> result; no need directly CityResponse.result= krege
...
applicationResponse.result=servletContext.getAttribute("cities");
...
{
System.out.println("Error in GetCity Servlet : "+exception); // remove after testing
}
