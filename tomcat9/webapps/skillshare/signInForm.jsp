      ...
      <div class="modal-body">
        <form action="login" id="addPostForm" method="post">
          <div class="form-group">
            <input type="text" name="userName" id="userName" class="form-control" placeholder="Username" style="margin-top: 15px" required>
            <input type="password" name="passWord" id="passWord" class="form-control" placeholder="Password" style="margin-top: 15px" required>
