  ...
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="signup" id="addPostForm" method="post">
          <div class="form-group">
            <input type="text" name="userName" id="userName" class="form-control" placeholder="Username">
            <input type="email" name="email" id="email" class="form-control" placeholder="Email" style="margin-top: 20px">
            <input type="password" name="passWord" id="passWord" class="form-control" placeholder="Password" style="margin-top: 20px">
            <input type="password" name="confirmPassWord" id="confirmPassWord" class="form-control" placeholder="Confirm Password" style="margin-top: 20px">
