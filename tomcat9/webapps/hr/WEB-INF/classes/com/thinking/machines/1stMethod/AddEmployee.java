...
pw.println("</head>");
pw.println("<body>");
pw.println("<h1>Employee (Add Module)</h1>");
pw.println("<h3 style='color:red'>"+firstName+" "+lastName+" exists</h3>");
pw.println("<form method='post' action='/hr/addEmployee' onsubmit='return validateForm(this)'>");
pw.println("<table>");
pw.println("<tr>");
...
preparedStatement=connection.prepareStatement("insert into employee(first_name,last_name,gender,is_permanent,city) values (?,?,?,?,?)");
preparedStatement.setString(1,firstName);
preparedStatement.setString(2,lastName);
